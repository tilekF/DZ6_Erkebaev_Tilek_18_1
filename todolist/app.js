...
const todoListAddBtn = document.querySelector("#todo-list-task-add-btn");
todoListAddBtn.addEventListener("click", AddTodo);
const todoListElement = document.getElementById("todo-list");

const deleteAllBtn = document.querySelector("#todo-list-task-delete-btn")
...
function AddTodo() {
  const todoListTaskText = document.getElementById("todo-list-task-text");

    // var liElement = document.createElement("li");
    // liElement.innerText = todoListTaskText;
    // todoListElement.appendChild(liElement);

    if(todoListTaskText.value.trim() !== "") {
      AddTodoToViewModel(todoListTaskText.value.trim());
    }

  todoListTaskText.value = ""
  RenderViewModel();
}
